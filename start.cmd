@echo off
TITLE A BetterPMMP 5.23.3 Server by xRookieFight
cd /d %~dp0
...
if exist BetterPMMP.phar (
	set POCKETMINE_FILE=BetterPMMP.phar
) else (
	echo BetterPMMP.phar not found
	echo Downloads can be found at https://github.com/xRookieFight/BetterPMMP/releases
	pause
	exit 1
)
