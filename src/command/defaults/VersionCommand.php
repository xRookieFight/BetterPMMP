...
class VersionCommand extends VanillaCommand{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		if(count($args) === 0){
			$sender->sendMessage("§aBu sunucu §f". VersionInfo::NAME . " ". VersionInfo::VERSION() ." §açalıştırıyor.");
			$sender->sendMessage("§aBu yazılım §fxRookieFight §atarafından §a yapılmıştır.");
			$sender->sendMessage("§aBu sunucunun PHP sürümü: §f" . PHP_VERSION);
		}else{
